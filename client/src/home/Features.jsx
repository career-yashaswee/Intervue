      ...
      <div className="container py-12 lg:py-16">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 items-center gap-2">
          ...
          >
            ...
            <div className="mt-5">
              <h3 className="text-lg font-semibold">Job and Applicant Insights</h3>
              <p className="mt-1 text-muted-foreground">
                Discover data and insights on jobs and how you’d be a top applicant based on your skills and experience.
              </p>
